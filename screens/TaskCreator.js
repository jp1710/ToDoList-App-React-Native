...
import { Colors ,ButtonText,StyledContainer,LeftIcon,StyledInputLabel,StyledTextInput, StyledButton, InnerContainer,InnerContainer2, StyledFormArea, PageTitle} from '../components/styles';
import DateTimePicker from '@react-native-community/datetimepicker';
import { Octicons, Ionicons,Entypo,FontAwesome,MaterialIcons} from '@expo/vector-icons';
...
const TaskCreator=({navigation,route})=>  {
  ...
  const triggerNotificationHandler = () => {
    ...
    return(
      ...
      <Appbar.Header style={styles.header}>
        ...
        <Appbar.Content titleStyle={{ marginRight: 150, fontSize:20, fontWeight:'bold' }} title="New Task"/>
      </Appbar.Header>
